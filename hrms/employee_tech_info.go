...
type SectionQuestionAnswer struct {
	...
	IsMandatory               bool             `bson:"is_mandatory"`
	WeightageInPercentage     float32          `bson:"weightage_in_percentage"`
	TotalSectionEmployeeScore string           `bson:"total_section_employee_score"`
	TotalSectionManagerScore  string           `bson:"total_section_manager_score"`
...
type Appraisal struct {
	...
	QuestionAnswers                 []QuestionAnswer             `bson:"question_answers"`
	SectionWiseQuestionAnswerSet    SectionWiseQuestionAnswerSet `bson:"section_wise_question_answer_set"`
...
type EmployeeTechInfo struct {
	...
	NoticePeriodTimeLine      []NoticePeriodDetails `bson:"notice_period_timeline,omitempty"`
	SeparationDetails         SeparationDetails     `bson:"separation_details"`
	SeparationDetailsTimeline []SeparationDetails   `bson:"separation_details_timeline,omitempty"`
