...
type Ticket struct {
	...
	CurrentMasterResolverId        string             `bson:"current_master_resolver_id"`
	CurrentMasterResolverName      string             `bson:"current_master_resolver_name"`
	CurrentMasterResolverEmail     string             `bson:"current_master_resolver_email"`
	CurrentSupervisorResolverId    string             `bson:"current_supervisor_resolver_id"`
	CurrentSupervisorResolverName  string             `bson:"current_supervisor_resolver_name"`
