...
type CountrySalaryStructure struct {
	...
	AnnualEmployeeProfessionalTaxContribution  float32             `bson:"annual_employee_professional_tax_contribution"`
	MonthlyEmployeeProfessionalTaxContribution float32             `bson:"monthly_employee_professional_tax_contribution"`
	...
	MonthlyPaidSalaryThisFinancialYear         []MonthlyPaidSalary `bson:"monthly_paid_salary_this_financial_year"`
...
type MonthlyPayrollAndTaxDetails struct {
	...
	OneTimeMonthlyTaxAdjustment     []OneTimeMonthlyTaxAdjustment `bson:"one_time_monthly_tax_adjustments"`
	IsMonthlySalaryDetailsAvailable bool                          `bson:"is_monthly_salary_details_available"`
	IsSalarySlipGenerated           bool                          `bson:"is_salary_slip_generated"`
	SalarySlipUploadURL             string                        `bson:"salary_slip_upload_url"`
	Remarks                         []string                      `bson:"remarks"`
	CreatedAt                       time.Time                     `bson:"created_at"`
	UpdatedAt                       time.Time                     `bson:"updated_at"`
}
...
type EmployeePayrollMaster struct {
	...
	EmployeeAnnualPayrollDetails                CountrySalaryStructure        `bson:"employee_annual_payroll_details"`
	CreatedAt                                   time.Time                     `bson:"created_at"`
	UpdatedAt                                   time.Time                     `bson:"updated_at"`
}
