...
type TenantLeavesConfig struct {
	...
	DefaultPrimaryApproverImgURL     string            `bson:"default_primary_img_url"`
	...
	DefaultSecondaryApproverImgURL   string            `bson:"default_secondary_img_url"`
	...
	BulkLeavePrimaryApproverImgURL   string            `bson:"bulk_leave_primary_img_url"`
	...
	BulkLeaveSecondaryApproverImgURL string            `bson:"bulk_leave_secondary_img_url"`
