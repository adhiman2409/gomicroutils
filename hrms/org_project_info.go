...
type ProjectInfo struct {
	...
	IsWholeOrgPartOfProject         bool                `bson:"is_whole_org_part_of_project"`
	...
	ExternalProjectCoordinatorName  string              `bson:"external_project_coordinator_name"`
	ExternalProjectCoordinatorId    string              `bson:"external_project_coordinator_id"`
	ExternalProjectCoordinatorEmail string              `bson:"external_project_coordinator_email"`
