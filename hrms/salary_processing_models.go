...
type SalaryProcessingRequest struct {
	...
	TotalActiveEmployees              int                           `bson:"total_active_employees"`
	TotalInactiveEmployees            int                           `bson:"total_inactive_employees"`
	TotalEmployeesWithNoSalaryDetails int                           `bson:"total_employees_with_no_salary_details"`
