...
// 	protoc        v5.26.1
// source: proto/attendance/type/emp_attendance.proto
...
func (x *AttendanceRequest) Reset() {
	*x = AttendanceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_attendance_type_emp_attendance_proto_msgTypes[0]
...
func (*AttendanceRequest) Descriptor() ([]byte, []int) {
	return file_proto_attendance_type_emp_attendance_proto_rawDescGZIP(), []int{0}
}
...
func (x *AttendanceResponse) Reset() {
	*x = AttendanceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_attendance_type_emp_attendance_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttendanceResponse) Descriptor() ([]byte, []int) {
	return file_proto_attendance_type_emp_attendance_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_attendance_type_emp_attendance_proto protoreflect.FileDescriptor

var file_proto_attendance_type_emp_attendance_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x74, 0x74, 0x65, 0x6e, 0x64, 0x61, 0x6e,
	0x63, 0x65, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x65, 0x6d, 0x70, 0x5f, 0x61, 0x74, 0x74, 0x65,
	0x6e, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x61, 0x74,
	0x74, 0x65, 0x6e, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x2d, 0x0a, 0x11, 0x41, 0x74, 0x74, 0x65,
	...
	0x6f, 0x72, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xb8, 0x04, 0x0a, 0x12, 0x41, 0x74, 0x74, 0x65,
	...
	0x12, 0x20, 0x0a, 0x0b, 0x6f, 0x66, 0x66, 0x69, 0x63, 0x65, 0x48, 0x6f, 0x75, 0x72, 0x73, 0x18,
	0x0d, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x6f, 0x66, 0x66, 0x69, 0x63, 0x65, 0x48, 0x6f, 0x75,
	0x72, 0x73, 0x42, 0x15, 0x5a, 0x13, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61,
	0x74, 0x74, 0x65, 0x6e, 0x64, 0x61, 0x6e, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_proto_attendance_type_emp_attendance_proto_rawDescOnce sync.Once
	file_proto_attendance_type_emp_attendance_proto_rawDescData = file_proto_attendance_type_emp_attendance_proto_rawDesc
)

func file_proto_attendance_type_emp_attendance_proto_rawDescGZIP() []byte {
	file_proto_attendance_type_emp_attendance_proto_rawDescOnce.Do(func() {
		file_proto_attendance_type_emp_attendance_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_attendance_type_emp_attendance_proto_rawDescData)
	})
	return file_proto_attendance_type_emp_attendance_proto_rawDescData
}

var file_proto_attendance_type_emp_attendance_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_attendance_type_emp_attendance_proto_goTypes = []interface{}{
	(*AttendanceRequest)(nil),  // 0: attendance.AttendanceRequest
	(*AttendanceResponse)(nil), // 1: attendance.AttendanceResponse
}
var file_proto_attendance_type_emp_attendance_proto_depIdxs = []int32{
...
func init() { file_proto_attendance_type_emp_attendance_proto_init() }
func file_proto_attendance_type_emp_attendance_proto_init() {
	if File_proto_attendance_type_emp_attendance_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_attendance_type_emp_attendance_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_attendance_type_emp_attendance_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_attendance_type_emp_attendance_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_attendance_type_emp_attendance_proto_goTypes,
		DependencyIndexes: file_proto_attendance_type_emp_attendance_proto_depIdxs,
		MessageInfos:      file_proto_attendance_type_emp_attendance_proto_msgTypes,
	}.Build()
	File_proto_attendance_type_emp_attendance_proto = out.File
	file_proto_attendance_type_emp_attendance_proto_rawDesc = nil
	file_proto_attendance_type_emp_attendance_proto_goTypes = nil
	file_proto_attendance_type_emp_attendance_proto_depIdxs = nil
}
